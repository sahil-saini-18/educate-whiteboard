...
export const UserList = React.memo(
  ({ className, mobile, collaborators, userToFollow }: UserListProps) => {
    ...
    console.log("uniqueCollaboratorsArray", uniqueCollaboratorsArray);

    let FirstId: any = "";
    if (collaborators.size > 0) {
      // Get the iterator for keys and retrieve the first key
      FirstId = collaborators.keys().next().value;
    }
