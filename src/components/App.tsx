...
import { exportToBlob } from "../packages/utils/export";
...
class App extends React.Component<AppProps, AppState> {
  ...
  private handleTextWysiwyg(
    ...
    textWysiwyg({
      ...
      onSubmit: withBatchedUpdates(({ viaKeyboard, originalText }) => {
        const isDeleted = !originalText.trim();
        updateElement(originalText, isDeleted);
